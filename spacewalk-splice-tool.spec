...
%changelog
* Tue Apr 08 2014 Chris Duryee <cduryee@redhat.com> 0.50-1
- fix spec file (cduryee@redhat.com)

* Tue Apr 08 2014 Chris Duryee <cduryee@redhat.com> 0.49-1
- clean up checkin.conf, and pep8 (cduryee@redhat.com)

* Fri Feb 21 2014 Chris Duryee (beav) <cduryee@redhat.com>
- forgot some wiring, and remove print statements (cduryee@redhat.com)
- allow users to flatten org structure if desired (cduryee@redhat.com)
- Allow disabling of autoentitle via conf file (cduryee@redhat.com)
- remove extraneous log statement (cduryee@redhat.com)
- 1064523: parse ';' properly in channel list when calculating clones
  (cduryee@redhat.com)
- add failing test for 1064523 (cduryee@redhat.com)
...
* Thu Sep 05 2013 Chris Duryee (beav) <cduryee@redhat.com>
- 1004335: abort with error if org names have '<>/' in them
  (cduryee@redhat.com)

* Tue Aug 20 2013 Chris Duryee (beav) <cduryee@redhat.com>
- remove debug print (vitty@redhat.com)

* Thu Aug 01 2013 Chris Duryee (beav) <cduryee@redhat.com>
- go back to findByProduct (cduryee@redhat.com)

* Thu Jul 25 2013 Chris Duryee (beav) <cduryee@redhat.com>
- ssh as user-configurable user instead of root (cduryee@redhat.com)
...
* Wed Jul 24 2013 Chris Duryee (beav) <cduryee@redhat.com>
- 984009: ssh timeout when fetching system list (cduryee@redhat.com)
- 987485: sync virt status based on is_virtualized (cduryee@redhat.com)
...
* Tue Jul 16 2013 John Matthews <jwmatthews@gmail.com> 0.31-1
- 980184 - discrepancies in /etc/splice/checkin.conf (jwmatthews@gmail.com)

* Tue Jul 16 2013 John Matthews <jwmatthews@gmail.com> 0.30-1
- 980180 - spacewalk-splice-tool package should be noarch
  (jwmatthews@gmail.com)
- add the spacewalk-id as soon as possible (cduryee@redhat.com)
